<template>
  <div id="InternationalFaculty">
    ...
    <v-row
      ><v-col
        v-for="item in InternationalProminentFacultyData"
        :key="item.Name"
        style="background-color: var(--BackgroundColor2-color)"
      >
        <DetailsCards :cardData="item"></DetailsCards></v-col
    ></v-row>
    <v-row>
...
export default {
  ...
  data() {
    return {
      ...
      InternationalProminentFacultyData: [
        {
          Name: "Dr. Shaji Kumar MD, FACP",
          Designation: "Consultant, Haematology Oncology",
          Department: "",
          Centre: "Mayo Clinic, Rochester, USA",
          Image: "InternationalFacultyPhotos/DrShajiKumar.png",
        },
      ],
      InternationalFacultyData: [
        ...
        },
        {
          ...
          Department: "",
          Centre:
            "Memorialcare Cancer Institute, Long Beach Medical Center, California, USA",
  ...
  mounted() {
    //
    // this.JsonCreator(this.InternationalFacultyRawData, this.InternationalFacultyData);
  },
  methods: {
    //
